...
path_to_s22_fu <- "~/projects/s22_follow_up/"
...
ids_to_exclude <- c('86041',
                    ...
                    "6442e71471e6b5dda4f99988",
                    "5a02083e087f2e0001eadbdb") #Ps whose data you don't want to analyze even if it looks good. Many of these are subjects from previous versions of ARL-BV. The last three are subjects who didn't submit.
##############
...
source(paste0(path_to_s22_fu,"code/functions/s22fu_utilities.R"))
