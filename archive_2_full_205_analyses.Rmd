...
First attempt at "clean model" runs of ARL-BV. But you later decided to change the way you set up the learning streams, and reran the models accordingly.
...
stan_model_dir <- paste0(path_to_project_directory,"code/stan_models/archive_clean_mods/")
model_out_dir <- paste0(path_to_project_directory,"output/results/stan_model_fits/archive_clean_mods/")
...
```{r}
rew <- fit_stan_model(stan_file=paste0(stan_model_dir,"rew.stan"),
                           model_out_dir=model_out_dir,
                           raw_data=trials,
                           study = "arlbv",
                           n_t = 144,
                           chains = 3)
aff <- fit_stan_model(stan_file=paste0(stan_model_dir,"aff.stan"),
                                             model_out_dir=model_out_dir,
                                             raw_data=trials,
                                             study = "arlbv",
                                             n_t = 144,
                                             chains = 3)
rew_aff <- fit_stan_model(stan_file=paste0(stan_model_dir,"rew_aff.stan"),
                                             model_out_dir=model_out_dir,
                                             raw_data=trials,
                                             study = "arlbv",
                                             n_t = 144,
...
rew_bv <- fit_stan_model(stan_file=paste0(stan_model_dir,"rew_bv.stan"),
                      ...
                      n_t = 144,
                      chains = 3)
full <- fit_stan_model(stan_file=paste0(stan_model_dir,"full.stan"),
                         model_out_dir=model_out_dir,
                         raw_data=trials,
                         study = "arlbv",
                         n_t = 144,
                         chains = 3)
rew_md <- fit_stan_model(stan_file=paste0(stan_model_dir,"rew_md.stan"),
                      model_out_dir=model_out_dir,
                      raw_data=medsplit,
                      study = "arlbv",
                      n_t = 144,
                      chains = 3)
rew_aff_md <- fit_stan_model(stan_file=paste0(stan_model_dir,"rew_aff_md.stan"),
                         model_out_dir=model_out_dir,
                         raw_data=medsplit,
                         study = "arlbv",
                         n_t = 144,
                         chains = 3)
rew_bv_md <- fit_stan_model(stan_file=paste0(stan_model_dir,"rew_bv_md.stan"),
                             model_out_dir=model_out_dir,
                             raw_data=medsplit,
                             study = "arlbv",
                             n_t = 144,
