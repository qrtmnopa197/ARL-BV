    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        if(t < n_t){
          ...
          Q[s,t+1] = (1-dcy_f[s])*Q[s,t];
          A[s,t+1] = (1-dcy_f[s])*A[s,t];
          B[s,t+1] = (1-dcy_f[s])*B[s,t];
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              //update Q...
              Q[s,t+1,fA[s,t]] = Q[s,t,fA[s,t]] + lrn_f[s]*(rew[s,t] - Q[s,t,fA[s,t]]);
              A[s,t+1,fA[s,t]] = A[s,t,fA[s,t]] + lrn_f[s]*(resid - A[s,t,fA[s,t]]);
              B[s,t+1,fA[s,t]] = B[s,t,fA[s,t]] + lrn_f[s]*(bv[s,t] - B[s,t,fA[s,t]]);
            } else if(fres[s,t] == 0){
              //otherwise update Q_nf
              Q_nf[s,t+1,fA[s,t]] = Q_nf[s,t,fA[s,t]] + lrn_nf[s]*(rew[s,t] - Q_nf[s,t,fA[s,t]]);
              A_nf[s,t+1,fA[s,t]] = A_nf[s,t,fA[s,t]] + lrn_nf[s]*(resid - A_nf[s,t,fA[s,t]]);
            }
            ...
            if(fres[s,t] == 1){
              //update Q...
              Q[s,t+1,fB[s,t]] = Q[s,t,fB[s,t]] + lrn_f[s]*(rew[s,t] - Q[s,t,fB[s,t]]);
              A[s,t+1,fB[s,t]] = A[s,t,fB[s,t]] + lrn_f[s]*(resid - A[s,t,fB[s,t]]);
              B[s,t+1,fB[s,t]] = B[s,t,fB[s,t]] + lrn_f[s]*(bv[s,t] - B[s,t,fB[s,t]]);
            } else if(fres[s,t] == 0){
              //otherwise update Q_nf
              Q_nf[s,t+1,fB[s,t]] = Q_nf[s,t,fB[s,t]] + lrn_nf[s]*(rew[s,t] - Q_nf[s,t,fB[s,t]]);
              A_nf[s,t+1,fB[s,t]] = A_nf[s,t,fB[s,t]] + lrn_nf[s]*(resid - A_nf[s,t,fB[s,t]]);
            }
          }
          //update C
