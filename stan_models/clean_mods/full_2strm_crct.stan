      ...
      for (t in 1:n_t){
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              //update Q...
              Q[s,t+1,fA[s,t]] = Q[s,t,fA[s,t]] + alpha[s]*(rew[s,t] - Q[s,t,fA[s,t]]);
              A[s,t+1,fA[s,t]] = A[s,t,fA[s,t]] + alpha[s]*(resid - A[s,t,fA[s,t]]);
              B[s,t+1,fA[s,t]] = B[s,t,fA[s,t]] + alpha[s]*(bv[s,t] - B[s,t,fA[s,t]]);
              ...
              B[s,t+1,fA[s,t]] = B[s,t,fA[s,t]];
              Q_nf[s,t+1,fA[s,t]] = Q_nf[s,t,fA[s,t]] + alpha[s]*(rew[s,t] - Q_nf[s,t,fA[s,t]]);
              A_nf[s,t+1,fA[s,t]] = A_nf[s,t,fA[s,t]] + alpha[s]*(resid - A_nf[s,t,fA[s,t]]);
            }
            ...
            if(fres[s,t] == 1){
              //update Q...
              Q[s,t+1,fB[s,t]] = Q[s,t,fB[s,t]] + alpha[s]*(rew[s,t] - Q[s,t,fB[s,t]]);
              A[s,t+1,fB[s,t]] = A[s,t,fB[s,t]] + alpha[s]*(resid - A[s,t,fB[s,t]]);
              B[s,t+1,fB[s,t]] = B[s,t,fB[s,t]] + alpha[s]*(bv[s,t] - B[s,t,fB[s,t]]);
              ...
              B[s,t+1,fB[s,t]] = B[s,t,fB[s,t]];
              Q_nf[s,t+1,fB[s,t]] = Q_nf[s,t,fB[s,t]] + alpha[s]*(rew[s,t] - Q_nf[s,t,fB[s,t]]);
              A_nf[s,t+1,fB[s,t]] = A_nf[s,t,fB[s,t]] + alpha[s]*(resid - A_nf[s,t,fB[s,t]]);
            }
          }
          //update C
