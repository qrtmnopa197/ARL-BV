  ...
  {//anonymous_scope_start
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = rewf_w[2,s]*Q[s,t,{fA[s,t],fB[s,t]}] + asens_f[s]*A[s,t,{fA[s,t],fB[s,t]}] + bvf_w[2,s]*B[s,t,{fA[s,t],fB[s,t]}] + 
                      rewnf_w[2,s]*Q_nf[s,t,{fA[s,t],fB[s,t]}] + asens_nf[s]*A_nf[s,t,{fA[s,t],fB[s,t]}] + csens[s]*C[s,t,{fA[s,t],fB[s,t]}] + [lsbias[s],0]';
