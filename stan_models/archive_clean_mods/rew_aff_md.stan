  ...
  {//anonymous_scope_start
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = rewf_sens[s]*Q[s,t,{fA[s,t],fB[s,t]}] + af_sens[s]*A[s,t,{fA[s,t],fB[s,t]}] 
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              ...
              A_nf[s,t+1,fA[s,t]] = A_nf[s,t,fA[s,t]] + lrn_anf[s]*(resid[s,t] - A_nf[s,t,fA[s,t]]);
            }
            ...
            if(fres[s,t] == 1){
              ...
              A_nf[s,t+1,fB[s,t]] = A_nf[s,t,fB[s,t]] + lrn_anf[s]*(resid[s,t] - A_nf[s,t,fB[s,t]]);
            }
          }
          //update C
