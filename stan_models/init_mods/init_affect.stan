...
data {
  ...
  array[n_s] vector[n_t] affect; // 1d array of vectors - one for each subject - that contains the outcome of each trial
  ...
  {//anonymous_scope_start
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = [beta[s]*Q[s,t,fA[s,t]] + beta_nfr[s]*Q_nfr[s,t,fA[s,t]] + phi[s]*C[s,t,fA[s,t]],
                       beta[s]*Q[s,t,fB[s,t]] + beta_nfr[s]*Q_nfr[s,t,fB[s,t]] + phi[s]*C[s,t,fB[s,t]]]'; //set softmax arg outside of the log_lik calculation for efficiency
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              //update Q...
              Q[s,t+1,fA[s,t]] = Q[s,t,fA[s,t]] + alpha[s]*(affect[s,t]-Q[s,t,fA[s,t]]);
            } else if(fres[s,t] == 0){
              //otherwise update Q_nfr
              Q_nfr[s,t+1,fA[s,t]] = Q_nfr[s,t,fA[s,t]] + alpha_nfr[s]*(affect[s,t]-Q_nfr[s,t,fA[s,t]]);
            }
            ...
            if(fres[s,t] == 1){
              //update Q...
              Q[s,t+1,fB[s,t]] = Q[s,t,fB[s,t]] + alpha[s]*(affect[s,t]-Q[s,t,fB[s,t]]);
            } else if(fres[s,t] == 0){
              //otherwise update Q_nfr
              Q_nfr[s,t+1,fB[s,t]] = Q_nfr[s,t,fB[s,t]] + alpha_nfr[s]*(affect[s,t]-Q_nfr[s,t,fB[s,t]]);
            }
          }
          //update C
