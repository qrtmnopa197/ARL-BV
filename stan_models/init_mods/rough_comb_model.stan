...
data {
  ...
  array[n_s] vector[n_t] affect; // 1d array of vectors - one for each subject - that contains the valence rating z score on each trial
      ...
      for (t in 1:n_t){
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            A[s,t+1,fA[s,t]] = A[s,t,fA[s,t]] + alearn[s]*(affect[s,t]-A[s,t,fA[s,t]]);
            ...
            A[s,t+1,fB[s,t]] = A[s,t,fB[s,t]] + alearn[s]*(affect[s,t]-A[s,t,fB[s,t]]);
            // C value update
            choice_a = 0;
            choice_b = 1;
          }
