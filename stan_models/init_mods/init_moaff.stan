        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              ...
              A_nfr[s,t+1,fA[s,t]] = A_nfr[s,t,fA[s,t]] + alearn_nfr[s]*(affect[s,t]-A_nfr[s,t,fA[s,t]]);
            }
            ...
            if(fres[s,t] == 1){
              ...
              A_nfr[s,t+1,fB[s,t]] = A_nfr[s,t,fB[s,t]] + alearn_nfr[s]*(affect[s,t]-A_nfr[s,t,fB[s,t]]);
            }
          }
          //update C
