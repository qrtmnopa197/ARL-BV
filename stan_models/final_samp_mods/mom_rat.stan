...
transformed parameters {
  ...
  {//anonymous_scope_start
    ...
    vector[n_s] x_sens = x_sens_mu + x_sens_sigma*x_sens_z;
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = rew_fr_sens[s]*Q_fr[s,t,{fA[s,t],fB[s,t]}] + rew_nf_sens[s]*Q_nf[s,t,{fA[s,t],fB[s,t]}] +
                      ...
                      x_sens[s]*X[s,t,{fA[s,t],fB[s,t]}] + csens[s]*C[s,t,{fA[s,t],fB[s,t]}]; //set argument for softmax decision function
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              ...
              X[s,t+1,fA[s,t]] = X[s,t,fA[s,t]] + lrn_fr[s]*(prev_rat[s,t] - X[s,t,fA[s,t]]);
            } else if(fres[s,t] == 0){
            ...
            if(fres[s,t] == 1){
              ...
              X[s,t+1,fB[s,t]] = X[s,t,fB[s,t]] + lrn_fr[s]*(prev_rat[s,t] - X[s,t,fB[s,t]]);
            } else if(fres[s,t] == 0){
              //otherwise update Q_nf
...
model{
  ...
  x_sens_mu ~ normal(0,4); 
  x_sens_sigma ~ normal(0,6); 
