...
transformed parameters {
  ...
  {//anonymous_scope_start
    ...
    //differences between Q, A, and R values of fractal A and fractal B
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        // unlesss this is the subject's last trial, set the expected values for the next trial
        if(t < n_t){
