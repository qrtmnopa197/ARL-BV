...
parameters{
  ...
  real box_fr_sens_mu; 
  real<lower=0> box_fr_sens_sigma;
  vector[n_s] box_fr_sens_z;
...
transformed parameters {
  ...
  {//anonymous_scope_start
    ...
    array[n_s,n_t] vector[n_f] M_fr; //ditto A-value...
    ...
    vector[n_s] box_fr_sens = box_fr_sens_mu + box_fr_sens_sigma*box_fr_sens_z;
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = rew_fr_sens[s]*Q_fr[s,t,{fA[s,t],fB[s,t]}] + rew_nf_sens[s]*Q_nf[s,t,{fA[s,t],fB[s,t]}] +
                      box_fr_sens[s]*M_fr[s,t,{fA[s,t],fB[s,t]}] + aff_nf_sens[s]*A_nf[s,t,{fA[s,t],fB[s,t]}] +
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              ...
              M_fr[s,t+1,fA[s,t]] = M_fr[s,t,fA[s,t]] + lrn_fr[s]*(bv[s,t] - M_fr[s,t,fA[s,t]]);
            ...
            if(fres[s,t] == 1){
              ...
              M_fr[s,t+1,fB[s,t]] = M_fr[s,t,fB[s,t]] + lrn_fr[s]*(bv[s,t] - M_fr[s,t,fB[s,t]]);
...
model{
  ...
  box_fr_sens_mu ~ normal(0,4); 
  box_fr_sens_sigma ~ normal(0,6); 
...
generated quantities{
  ...
  real scd_box_fr_sens_mu = M_fr_sd*box_fr_sens_mu;
