...
transformed parameters {
  ...
  {//anonymous_scope_start
    ...
    matrix[n_s,n_t] M_fr_diff;
    matrix[n_s,n_t] M_nf_diff;
    matrix[n_s,n_t] R_fr_diff;
    matrix[n_s,n_t] R_nf_diff;
    matrix[n_s,n_t] N_fr_diff;
    matrix[n_s,n_t] N_nf_diff;
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = rew_fr_sens[s]*Q_fr[s,t,{fA[s,t],fB[s,t]}] + rew_nf_sens[s]*Q_nf[s,t,{fA[s,t],fB[s,t]}] +
                      ma_fr_sens[s]*M_fr[s,t,{fA[s,t],fB[s,t]}] + ma_nf_sens[s]*M_nf[s,t,{fA[s,t],fB[s,t]}] + 
                      resid_fr_sens[s]*R_fr[s,t,{fA[s,t],fB[s,t]}] + resid_nf_sens[s]*R_nf[s,t,{fA[s,t],fB[s,t]}] + 
                      nuis_fr_sens[s]*N_fr[s,t,{fA[s,t],fB[s,t]}] + nuis_nf_sens[s]*N_nf[s,t,{fA[s,t],fB[s,t]}] + 
        ...
        M_fr_diff[s,t] = M_fr[s,t,fA[s,t]] - M_fr[s,t,fB[s,t]];
        M_nf_diff[s,t] = M_nf[s,t,fA[s,t]] - M_nf[s,t,fB[s,t]];
        R_fr_diff[s,t] = R_fr[s,t,fA[s,t]] - R_fr[s,t,fB[s,t]];
        R_nf_diff[s,t] = R_nf[s,t,fA[s,t]] - R_nf[s,t,fB[s,t]];
        N_fr_diff[s,t] = N_fr[s,t,fA[s,t]] - N_fr[s,t,fB[s,t]];
        N_nf_diff[s,t] = N_nf[s,t,fA[s,t]] - N_nf[s,t,fB[s,t]];
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              ...
              M_fr[s,t+1,fA[s,t]] = M_fr[s,t,fA[s,t]] + lrn_fr[s]*(curr_pred - M_fr[s,t,fA[s,t]]);
              R_fr[s,t+1,fA[s,t]] = R_fr[s,t,fA[s,t]] + lrn_fr[s]*(resid - R_fr[s,t,fA[s,t]]);
              N_fr[s,t+1,fA[s,t]] = N_fr[s,t,fA[s,t]] + lrn_fr[s]*(nuis - N_fr[s,t,fA[s,t]]);
            } else if(fres[s,t] == 0){
              //otherwise update Q_nf
              Q_nf[s,t+1,fA[s,t]] = Q_nf[s,t,fA[s,t]] + lrn_nf[s]*(rew[s,t] - Q_nf[s,t,fA[s,t]]);
              M_nf[s,t+1,fA[s,t]] = M_nf[s,t,fA[s,t]] + lrn_nf[s]*(curr_pred - M_nf[s,t,fA[s,t]]);
              R_nf[s,t+1,fA[s,t]] = R_nf[s,t,fA[s,t]] + lrn_nf[s]*(resid - R_nf[s,t,fA[s,t]]);
              N_nf[s,t+1,fA[s,t]] = N_nf[s,t,fA[s,t]] + lrn_nf[s]*(nuis - N_nf[s,t,fA[s,t]]);
            }
            ...
            if(fres[s,t] == 1){
              ...
              M_fr[s,t+1,fB[s,t]] = M_fr[s,t,fB[s,t]] + lrn_fr[s]*(curr_pred - M_fr[s,t,fB[s,t]]);
              R_fr[s,t+1,fB[s,t]] = R_fr[s,t,fB[s,t]] + lrn_fr[s]*(resid - R_fr[s,t,fB[s,t]]);
              N_fr[s,t+1,fB[s,t]] = N_fr[s,t,fB[s,t]] + lrn_fr[s]*(nuis - N_fr[s,t,fB[s,t]]);
            } else if(fres[s,t] == 0){
              //otherwise update Q_nf
              Q_nf[s,t+1,fB[s,t]] = Q_nf[s,t,fB[s,t]] + lrn_nf[s]*(rew[s,t] - Q_nf[s,t,fB[s,t]]);
              M_nf[s,t+1,fB[s,t]] = M_nf[s,t,fB[s,t]] + lrn_nf[s]*(curr_pred - M_nf[s,t,fB[s,t]]);
              R_nf[s,t+1,fB[s,t]] = R_nf[s,t,fB[s,t]] + lrn_nf[s]*(resid - R_nf[s,t,fB[s,t]]);
              N_nf[s,t+1,fB[s,t]] = N_nf[s,t,fB[s,t]] + lrn_nf[s]*(nuis - N_nf[s,t,fB[s,t]]);
            }
          }
          //update C
    ...
    M_fr_sd = sd(M_fr_diff);
    M_nf_sd = sd(M_nf_diff);
    R_fr_sd = sd(R_fr_diff);
    R_nf_sd = sd(R_nf_diff);
    N_fr_sd = sd(N_fr_diff);
    N_nf_sd = sd(N_nf_diff);
    C_sd = sd(C_diff);
  }//anonymous_scope_end
}
model{
