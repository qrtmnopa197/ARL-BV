        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              ...
              A_fr[s,t+1,fA[s,t]] = A_fr[s,t,fA[s,t]] + lrn_fr[s]*curr_pred;
              R_fr[s,t+1,fA[s,t]] = R_fr[s,t,fA[s,t]] + lrn_fr[s]*resid;
            } else if(fres[s,t] == 0){
            ...
            if(fres[s,t] == 1){
              ...
              A_fr[s,t+1,fB[s,t]] = A_fr[s,t,fB[s,t]] + lrn_fr[s]*curr_pred;
              R_fr[s,t+1,fB[s,t]] = R_fr[s,t,fB[s,t]] + lrn_fr[s]*resid;
            } else if(fres[s,t] == 0){
