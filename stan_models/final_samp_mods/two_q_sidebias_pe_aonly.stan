...
transformed parameters {
  ...
  {//anonymous_scope_start
    ...
    real affect; //the affect on the current trial. If a rating was made this is the valence rating.
                 //If the rating was skipped it's 0
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = rew_nf_sens[s]*Q_nf[s,t,{fA[s,t],fB[s,t]}] +
                      aff_fr_sens[s]*A_fr[s,t,{fA[s,t],fB[s,t]}] +
                      csens[s]*C[s,t,{fA[s,t],fB[s,t]}] + 
                      [ls_bias[s],0]'; //set argument for softmax decision function
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              //update Q_fr...
              A_fr[s,t+1,fA[s,t]] = A_fr[s,t,fA[s,t]] + lrn_fr[s]*affect;
            } else if(fres[s,t] == 0){
            ...
            if(fres[s,t] == 1){
              //update Q_fr...
              A_fr[s,t+1,fB[s,t]] = A_fr[s,t,fB[s,t]] + lrn_fr[s]*affect;
            } else if(fres[s,t] == 0){
              //otherwise update Q_nf
