    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        softmax_arg = rew_fr_sens[s]*Q_fr[s,t,{fA[s,t],fB[s,t]}] + rew_nf_sens[s]*Q_nf[s,t,{fA[s,t],fB[s,t]}] +
                      ...
                      resid_fr_sens[s]*R_fr[s,t,{fA[s,t],fB[s,t]}] + csens[s]*C[s,t,{fA[s,t],fB[s,t]}]; //set argument for softmax decision function
        ...
        if(t < n_t){
          ...
          if(choice[s,t] == 1){
            ...
            if(fres[s,t] == 1){
              ...
              A_nf[s,t+1,fA[s,t]] = A_nf[s,t,fA[s,t]] + lrn_nf[s]*(curr_pred + nuis + resid - A_nf[s,t,fA[s,t]]);
            }
            ...
            if(fres[s,t] == 1){
              ...
              A_nf[s,t+1,fB[s,t]] = A_nf[s,t,fB[s,t]] + lrn_nf[s]*(curr_pred + nuis + resid - A_nf[s,t,fB[s,t]]);
            }
          }
          //update C
