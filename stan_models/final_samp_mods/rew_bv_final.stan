// Q-learning model in which Q values are updated by reward sand box values
...
parameters{
  ...
  real bv_fr_sens_mu; 
  real<lower=0> bv_fr_sens_sigma;
  vector[n_s] bv_fr_sens_z;
...
transformed parameters {
  ...
  {//anonymous_scope_start
    ...
    array[n_s,n_t] vector[n_f] B_fr; //ditto A-value...
    ...
    vector[n_s] bv_fr_sens = bv_fr_sens_mu + bv_fr_sens_sigma*bv_fr_sens_z;
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        B_fr_diff[s,t] = B_fr[s,t,fA[s,t]] - B_fr[s,t,fB[s,t]];
        ...
        if(t < n_t){
          ...
          B_fr[s,t+1] = (1-dcy_fr[s])*B_fr[s,t];
          if(choice[s,t] == 1){
            // if fA was chosen...
            ...
            if(fres[s,t] == 1){
              ...
              B_fr[s,t+1,fA[s,t]] = B_fr[s,t,fA[s,t]] + lrn_fr[s]*(bv[s,t] - B_fr[s,t,fA[s,t]]);
            } else if(fres[s,t] == 0){
            ...
            if(fres[s,t] == 1){
              ...
              B_fr[s,t+1,fB[s,t]] = B_fr[s,t,fB[s,t]] + lrn_fr[s]*(bv[s,t] - B_fr[s,t,fB[s,t]]);
            } else if(fres[s,t] == 0){
...
model{
  ...
  bv_fr_sens_mu ~ normal(0,4); 
  bv_fr_sens_sigma ~ normal(0,6); 
...
generated quantities{
  ...
  real scd_bv_fr_sens_mu = B_fr_sd*bv_fr_sens_mu;
